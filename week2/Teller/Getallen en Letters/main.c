...
int main() // Hoofd functie
{
	...
	void welkCijfer(int eerste, int tweede) // Functie voor het laten zien van de cijfers en letters
	{
	...
	{
		int tellerTwee; // Initieer de tellerTwee voor het tellen om het cijfer of letter te bepalen ( c99 modus voor de arduinoISP)
		for(tellerTwee = 0; tellerTwee < 256; tellerTwee++) // Voor tellerTwee is kleiner dan 256, en elke keer als programma hier komt, tellerTwee + 1
		{
			int eerste = tellerTwee / 16; // Eerste cijfer is tellerTwee gedeeld door 16
			int tweede = tellerTwee%16; // Tweede cijfer is tellerTwee modulus 16
